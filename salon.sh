...
MAIN_MENU() {
    ...
    then
      ...
      then
        MAIN_MENU "That is not a number. Please choose a valid service."
      else
        ...
        then
          ...
          SERVICE_NAME=$($PSQL "SELECT name FROM services WHERE service_id = $SERVICE_ID_SELECTED")  # Get the name of the service
